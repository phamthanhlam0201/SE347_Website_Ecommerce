...
export default function CommonDetails({ item, cmtitem }) {
  ...
  return (
    ...
    <section className="mx-auto max-w-screen-sm md:max-w-screen-xl px-4 sm:px-6 lg:px-8 py-7 mt-8 md:mt-0">
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="lg:col-span-3">
              <div>
                ...
                <pre className="break-words overflow-x-auto max-w-full md:max-w-md ">{item && item.description}</pre>
              </div>
            </div>
          </div>
        </div>
